...
namespace CSHttpClientSample
{
    static class Program
    {
        ...
        const string subscriptionKey = "bad513b883464a39beff3d8cc6da5acb";
        ...
        static void Main()
        {
            ...
            Console.WriteLine("###############################");
            Console.WriteLine("## FACE ANALYSIS APPLICATION ##");
            Console.WriteLine("###############################");
            Console.Write("\nEnter the file path to the image you wish to analyze: ");
        ...
        static async void MakeAnalysisRequest(string imageFilePath)
        {
            ...
            using (ByteArrayContent content = new ByteArrayContent(byteData))
            {
                ...
                Console.WriteLine("End of the raw unformatted response");
...
//REF source code examples from Mircrosoft
//https://azure.microsoft.com/en-us/services/cognitive-services/face/ (Links to an external site.)Links to an external site.
